...
const WARNINGS = {
  ...
  C_PACK_REMOVED: byLocale(['功能支持包被移除，相应的专项营养支持会减弱。','A functional support pack was removed, so its targeted nutritional support will be reduced.','Ein Funktionspaket wurde entfernt; die gezielte Unterstützung nimmt dadurch ab.','Un pack fonctionnel a été retiré ; son soutien nutritionnel ciblé sera réduit.','Se retiró un pack funcional, por lo que disminuirá su apoyo nutricional específico.','È stato rimosso un pack funzionale, riducendo il supporto nutrizionale mirato.','機能サポートパックが外されたため、対象となる栄養サポートが弱まります。','기능 지원 팩이 제거되어 해당 맞춤 영양 지원이 줄어듭니다.']),
