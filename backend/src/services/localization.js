...
const KNOWN_FINDING_CODES = new Set([
  ...
  'PROFESSIONAL_CONFIRMATION_REQUIRED', 'PUPPY_TARGET_WEIGHT_CONFLICT', 'LOW_ANIMAL_PROTEIN', 'HIGH_CARB',
  'HIGH_VEGETABLE', 'LOW_FAT_SOURCE', 'MACRO_DATA_INCOMPLETE', 'INGREDIENT_NUTRITION_UNAVAILABLE',
